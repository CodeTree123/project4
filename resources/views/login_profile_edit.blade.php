            ...
            <div class="container flex-grow-1 flex-shrink-0 py-5">
                <div class="mb-5 p-4 bg-white shadow-sm">
                    ...
                    <div id="test-l-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger1"> 
                                            <div class="form-floating ">
                                                <input type="number" name="mobile" class="form-control mb-2" id="floatingInput" placeholder="Name">
                                                <label for="floatingInput">Mobile Number</label>
                                            </div>
                                            <!-- <div class="form-floating">
                                                <input type="text" name="fName" class="form-control mb-2" id="fName" placeholder="First Name">
                                            ...
                                            <select class="form-select" aria-label="Select Blood Group">
